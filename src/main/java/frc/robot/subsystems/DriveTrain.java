...
talonFXEnhanced3.configOpenloopRamp(8, 1);// added ramp to all drive motors
...
talonFXEnhanced4.configOpenloopRamp(.8, 1);
...
talonFXEnhanced1.configOpenloopRamp(.8, 1);
...
talonFXEnhanced2.configOpenloopRamp(.8, 1);;
