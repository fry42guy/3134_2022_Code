...
private final Joystick driver = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand(m_driveTrain, m_ele, m_intake));
    ...
    // Configure autonomous sendable chooser
        ...
        m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand(m_driveTrain, m_ele,m_intake));
