...
// The robot's subsystems
    ...
    public double Auto_Stear_KP = .05;
...
private final Joystick driver = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand(m_driveTrain, m_ele, m_intake, myLimeLight));
    SmartDashboard.putData("Autonomous Command", new TwoBallAuto(m_driveTrain, m_ele, m_intake, myLimeLight));
    ...
    SmartDashboard.putNumber("KP for auto steal_beta", Auto_Stear_KP);
    ...
    // Configure autonomous sendable chooser
        ...
        m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand(m_driveTrain, m_ele,m_intake, myLimeLight));
      
        m_chooser.addOption("Two Ball Auto", new TwoBallAuto(m_driveTrain, m_ele,m_intake, myLimeLight));
  ...
  private void configureButtonBindings() {
    final JoystickButton Autostear = new JoystickButton(driver, 10);      
        Autostear.whenHeld(new drivewithLimelightStear(()->-driver.getRawAxis(1),myLimeLight, m_driveTrain), true);
        SmartDashboard.putData("Auto Stear",new drivewithLimelightStear(()-> -driver.getRawAxis(1),myLimeLight, m_driveTrain) );
